...
namespace Sprint0.Characters.States.DodongoStates
{
    public class DodongoGameModeTransitionState : AbstractCharacterState
    {
        ...
        public DodongoGameModeTransitionState(AbstractCharacter character, IGameMode oldGameMode, IGameMode newGameMode,
            Types.Direction direction = Types.Direction.NO_DIRECTION) : base(character)
        {
            ...
            character.Sprite = oldGameMode.GetDodongoSprite(this, direction);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                if (FlashesPassed % 2 == 0) Character.Sprite = NewGameMode.GetDodongoSprite(this, Direction);
                else Character.Sprite = OldGameMode.GetDodongoSprite(this, Direction);

                FlashesPassed++;
                if (FlashesPassed > NumFlashes)
                {
                    Character.Sprite = NewGameMode.GetDodongoSprite(this, Direction);
                    Character.State = new DodongoMovingState(Character, Direction);
                }
            }
        }
    }
