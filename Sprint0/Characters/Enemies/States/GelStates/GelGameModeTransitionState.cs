...
namespace Sprint0.Characters.States.GelStates
{
    public class GelGameModeTransitionState : AbstractCharacterState
    {
        ...
        public GelGameModeTransitionState(AbstractCharacter character, IGameMode oldGameMode, IGameMode newGameMode,
            Types.Direction direction = Types.Direction.NO_DIRECTION) : base(character)
        {
            ...
            character.Sprite = oldGameMode.GetGelSprite(this, direction);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                if (FlashesPassed % 2 == 0) Character.Sprite = NewGameMode.GetGelSprite(this, Direction);
                else Character.Sprite = OldGameMode.GetGelSprite(this, Direction);

                FlashesPassed++;
                if (FlashesPassed > NumFlashes)
                {
                    Character.Sprite = NewGameMode.GetGelSprite(this, Direction);
                    Character.State = new GelMovingState(Character, Direction);
                }
            }
        }
    }
