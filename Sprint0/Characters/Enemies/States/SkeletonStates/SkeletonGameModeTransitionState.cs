...
namespace Sprint0.Characters.States.Skeleton
{
    public class SkeletonGameModeTransitionState : AbstractCharacterState
    {
        ...
        public SkeletonGameModeTransitionState(AbstractCharacter character, IGameMode oldGameMode, IGameMode newGameMode,
            Types.Direction direction = Types.Direction.NO_DIRECTION) : base(character)
        {
            ...
            character.Sprite = oldGameMode.GetSkeletonSprite(this, direction);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                if (FlashesPassed % 2 == 0) Character.Sprite = NewGameMode.GetSkeletonSprite(this, Direction);
                else Character.Sprite = OldGameMode.GetSkeletonSprite(this, Direction);

                FlashesPassed++;
                if (FlashesPassed > NumFlashes)
                {
                    Character.Sprite = NewGameMode.GetSkeletonSprite(this, Direction);
                    Character.State = new SkeletonMovingState(Character, Direction);
                }
            }
        }
    }
