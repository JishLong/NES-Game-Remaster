...
namespace Sprint0.Characters.Enemies.States
{
    public class SnakeMovingState : AbstractCharacterState
    {
        ...
        public SnakeMovingState(AbstractCharacter character) : base(character) { }
        ...
        public override void ChangeDirection()
        {
            ...
            if (Direction == Types.Direction.LEFT || Direction == Direction.RIGHT) Character.SetSprite(Direction);
        }
