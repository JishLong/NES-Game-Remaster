...
namespace Sprint0.Characters.States.ZolStates
{
    public class ZolGameModeTransitionState : AbstractCharacterState
    {
        ...
        public ZolGameModeTransitionState(AbstractCharacter character, IGameMode oldGameMode, IGameMode newGameMode,
            Types.Direction direction = Types.Direction.NO_DIRECTION) : base(character)
        {
            ...
            character.Sprite = oldGameMode.GetZolSprite(this, direction);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                if (FlashesPassed % 2 == 0) Character.Sprite = NewGameMode.GetZolSprite(this, Direction);
                else Character.Sprite = OldGameMode.GetZolSprite(this, Direction);

                FlashesPassed++;
                if (FlashesPassed > NumFlashes)
                {
                    Character.Sprite = NewGameMode.GetZolSprite(this, Direction);
                    Character.State = new ZolMovingState(Character, Direction);
                }
            }
        }
    }
