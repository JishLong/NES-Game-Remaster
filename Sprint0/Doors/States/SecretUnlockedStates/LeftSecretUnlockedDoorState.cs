...
{
    public class LeftSecretUnlockedDoorState : AbstractTraversableDoorState
    {
        public LeftSecretUnlockedDoorState(Door door)
        {
            // Set context
            Door = door;
            ...
            // Create sprites
            DoorWaySprite = new LeftSecretDoorWaySprite();
            DoorWallSprite = new LeftSecretDoorWallSprite();
