...
{
    public class LeftTransitionState : AbstractGameState
    {
        ...
        public LeftTransitionState()
        {
            Controllers = new System.Collections.Generic.List<IController>();

            CurrentRoom = Game.LevelManager.CurrentLevel.CurrentRoom;
            NextRoom = Game.LevelManager.CurrentLevel.CurrentRoom.GetAdjacentRoom(Types.RoomTransition.LEFT);
            FramesPassed = 0;
        }
        ...
        public override void Draw(SpriteBatch sb)
        {
            ...
            Camera.Move(Types.Direction.LEFT, Utils.GameWidth / TransitionFrames);
            CurrentRoom.Draw(sb);
            ...
            {
                Camera.Reset();
                Game.LevelManager.CurrentLevel.CurrentRoom.MakeTransition(Types.RoomTransition.LEFT);
                Game.UnpauseGame();
            }
        }
    }
