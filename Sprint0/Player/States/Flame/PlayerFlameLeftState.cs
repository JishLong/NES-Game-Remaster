...
namespace Sprint0.Player.States.Flame
{
    public class PlayerFlameLeftState : AbstractPlayerState
    {
        ...
        private void SpawnFlame()
        {
            ...
            float FlameX = Player.GetHitbox().Left - Resources.FlameProj.Width * Utils.GameScale;
            ...
            ProjectileManager.GetInstance().AddProjectile(
                Types.Projectile.FLAMEPROJ, new Vector2(FlameX, FlameY), Types.Direction.LEFT, null);
        }
