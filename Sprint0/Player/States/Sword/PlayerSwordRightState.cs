...
namespace Sprint0.Player.State.Idle
{
    public class PlayerSwordRightState : AbstractPlayerState
    {
        ...
        {
            ProjectileManager.GetInstance().AddProjectile(Types.Projectile.SWORD_MELEE, Player, Types.Direction.RIGHT);
        ...
        public override void Update()
        {
            ...
            if (FramesPassed % Sprite.GetAnimationTime() == 0) 
            {
                ...
                {                
                    ProjectileManager.GetInstance().AddProjectile(Types.Projectile.SWORD_PROJ, Player, Types.Direction.RIGHT);
