...
namespace Sprint0.Sprites.Items
{
    public class ArrowSprite : AbstractSprite
    {
        ...
        protected override Rectangle GetFirstFrame() => ImageMappings.GetInstance().Arrow;

        protected override Rectangle GetDefaultFrame() => AssetManager.DefaultImageAssets.Arrow;
    }
}
