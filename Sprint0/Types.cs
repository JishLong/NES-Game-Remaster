namespace Sprint0
{
    ...
    public static class Types
    {
        public enum Block
        {
            ...
            ROOM_TRANSITION_BLOCK, SOFT_BORDER_BLOCK, WATER, WHITE_BARS, UNLOCK_DOOR_TRIGGER,
        };

        public enum Border { BLUE_BORDER, NONE }

        public enum Character { AQUAMENTUS, BLADE_TRAP, BAT, DODONGO, FLAME, GEL, HAND, OLDMAN, RED_GORIYA, SECRET_TEXT, SKELETON, SNAKE, ZOL }
