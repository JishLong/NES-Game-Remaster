namespace Sprint0
{
    ...
    public static class Types
    {
        ...
        GREY_BRICKS, LADDER, WHITE_BARS, PUSHABLE_BLOCK, BORDER_BLOCK, LEFT_DOOR_WAY_BLOCK, RIGHT_DOOR_WAY_BLOCK, LEFT_TRANSITION_TRIGGER };

        public enum Door { UP_LOCKED, RIGHT_LOCKED, DOWN_LOCKED, LEFT_LOCKED, 
                           UP_UNLOCKED, RIGHT_UNLOCKED, DOWN_UNLOCKED, LEFT_UNLOCKED,
                           UP_EVENT_LOCKED, RIGHT_EVENT_LOCKED, DOWN_EVENT_LOCKED, LEFT_EVEN_LOCKED,
